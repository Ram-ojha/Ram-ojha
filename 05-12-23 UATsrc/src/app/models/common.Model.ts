...
export class ApplicationVehicleData implements IApplicationVehicleData {
  ...
  public PrvInsurerCode!: number;
  public PrvInsurerName!: string;
...
export interface IApplicationVehicleData {
  ...
  PrvInsurerCode: number;
  PrvInsurerName: string;
  //CV
...
export interface IPolicyPDFDocDownload {
  PolicyNo: string;
  ...
  ProposalOrderNo: string;
  ComprehensiveThirdPartyCode: string;
  SubCateCode: number
  InsuranceCateCode: number
...
export interface ICKYCUnitedIndia {
...
export interface ICKYCOriental {

  ApplicationNo: Number,
  RegistrationNo: any

}
export interface ICKYCOrientalStatus {
...
export interface ICKYCShreeRam {
  ...
  PanNumber?: string;
  PanImageBase64?: string | ArrayBuffer;
}
