...
export class CvPaymentComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    // this.policyData.ApplicationNo = Number(decrypt(sessionStorage.getItem("appNo")));
    ...
    this._subscriptions.push(
      this._route.paramMap.subscribe((p: any) => {
        ...
        // this.policyData.ApplicationNo = Number(decrypt(No));
        // this.policyData.ApplicationNoOdp = Number(decrypt(Odp));
      })
    );
    ...
    // console.log("this.policyData.ApplicationNo",this.policyData.ApplicationNo)
    // console.log("this.policyData.ApplicationNoOdp",this.policyData.ApplicationNoOdp)
  }
        ...
        this.getPaymentDataEndPoint()!.subscribe((result) => {
          ...
          if (result && result.data) {
            ...
            if (result.successcode == "0") {
              ...
              this.errorLogDetails.ApplicationNo = this.policyData.ApplicationNo;
  ...
  //   if (+this.policyData.CompanyCode === 7)
  //     return this._vehicleBuyPlanService.GetSbiDataAfterPayment(this.key);
  //   if (!this.policyData.ApplicationNo || !this.RegistrationNo)
  //     return this._vehicleBuyPlanService.GetDataAfterPaymentByKey(this.key);
  //   else
  //     return this._vehicleBuyPlanService.GetDataAfterPayment(
  //       this.RegistrationNo,
  //       this.policyData.ApplicationNo
  //     );
  // }
  ...
  updatePayment() {
    ...
    const data: paymentRequestData = {
      ...
      ApplicationNoOdp: this.policyData.ApplicationNoOdp,
