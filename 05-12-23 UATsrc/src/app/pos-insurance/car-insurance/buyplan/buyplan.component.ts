...
export class BuyplanComponent implements OnInit, OnDestroy {
  ...
  identityMask!: {
    guide: boolean; keepCharPositions: boolean; showMask: boolean; //all list objects
    mask: RegExp[];
  };
  ...
  ngOnInit() {
    ...
    console.log(this.premiumDataPlans);
                ...
                .subscribe(
                  (result) => {
                    ...
                    if (this.premiumDataPlans.CompanyCode != '13' &&
                      this.premiumDataPlans.CompanyCode != '12' &&
                      this.premiumDataPlans.CompanyCode != '2' &&
                      this.premiumDataPlans.CompanyCode != '10') {
                      debugger
                      this.setMortgageValidators();
                    }
                    if (this.PlanData.CompanyCode != '7') {
  ...
  async onChangeDistrict() {
    ...
    // console.log(district);
    this.showLoader = true;
    console.log(this.addressForm.controls["city"], this.addressForm.controls)
    // this.addressForm.controls["city"].reset();
    // this.addressForm.controls["pincode"].reset();
    this._subscriptions.push(
