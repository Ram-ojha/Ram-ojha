...
import { ApplicationVehicleData, errorLog, IInsuranceCompany } from "src/app/models/common.Model";
...
export class CarPlansComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  modelclose1(id: any) {
    ...
    this.myPAcoverModel = "none";
    if (id !== undefined && this.plan.SubCateCode == 3 && id !== null) {
    ...
    } else if (id !== undefined && this.plan.SubCateCode == 4 && id !== null) {
  ...
  popupData(item: any, ApplicationNo: number) {
    ...
    this.premiumDataPlans["ApplicationNo"] = this.postData.ApplicationNo
